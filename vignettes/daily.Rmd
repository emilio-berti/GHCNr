...
saved_api_call <- "/home/squirry/GHCNr/vignettes/daily/0/www.ncei.noaa.gov/access/services/data/v1-1c6ea3.json"
daily_ts <- saved_api_call |> 
  jsonlite::read_json() |> 
  dplyr::bind_rows() |> 
  dplyr::rename_with( ~tolower(.x), dplyr::everything()) |> 
  as_daily()
daily_ts
```
...
```
```{r mltidaily-saved, echo=FALSE}
saved_api_call <- "/home/squirry/GHCNr/vignettes/daily/0/www.ncei.noaa.gov/access/services/data/v1-c8c863.json"
daily_ts <- saved_api_call |> 
  jsonlite::read_json() |> 
  dplyr::bind_rows() |> 
  dplyr::rename_with( ~tolower(.x), dplyr::everything()) |> 
